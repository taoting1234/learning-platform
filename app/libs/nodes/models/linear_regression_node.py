...
class LinearRegressionNode(BaseNode):
    ...
    def run(self):
        ...
        self.logger.info('mse: {}'.format(mean_squared_error(y_test, y_pred)))
        self.logger.info('mae: {}'.format(mean_absolute_error(y_test, y_pred)))
        self.logger.info('r2: {}'.format(r2_score(y_test, y_pred)))
