...
user_register_parser.add_argument("organization", type=str, required=True)
user_register_parser.add_argument("captcha", type=str, required=True)
user_register_parser.add_argument("code", type=str, required=True)
