...
class NotSplitInputNode(InputNode):
    ...
    def __init__(self, id_, node_type, project_id, in_edges, out_edges, extra):
        super().__init__(id_, node_type, project_id, in_edges, out_edges, extra)
        self.checked_params["label_columns"] = change_columns(
            self.checked_params["label_columns"]
        )
        ...
        assert os.path.commonpath(
            ...
            self.checked_params["real_input_file"]
        ), "file not found！"
...
class SplitInputNode(InputNode):
    ...
    def __init__(self, id_, node_type, project_id, in_edges, out_edges, extra):
        super().__init__(id_, node_type, project_id, in_edges, out_edges, extra)
        assert (
            self.checked_params["x_input_file"][0] == "/"
        ), "x_input_file format error"
        ...
        assert os.path.commonpath(
            ...
            self.checked_params["real_x_input_file"]
        ), "x_input_file not found！"
        assert (
            self.checked_params["y_input_file"][0] == "/"
        ), "y_input_file format error"
        ...
        assert os.path.commonpath(
            ...
            self.checked_params["real_y_input_file"]
        ), "y_input_file not found！"
